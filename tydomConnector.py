...
class TydomWebSocketClient():
    ...
    def __init__(self, mac, password, alarm_pin=None, host='mediation.tydom.com'):
        logger_info.info('Initialising TydomClient Class')
        ...
        if self.host == "mediation.tydom.com":
            ...
            logger_info.info('Setting local mode context.')
    ...
    async def connect(self):
        ...
        #print('""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""')
        logger_info.info('TYDOM WEBSOCKET CONNECTION INITIALISING....                     ')

    
        
        logger_info.info('Building headers, getting 1st handshake and authentication....')
        ...
        #print("GET", "/mediation/client?mac={}&appli=1".format(self.mac), None, httpHeaders)
        ...
        logger_info.info('Upgrading http connection to websocket....')
    ...
    # outer loop restarted every time the connection fails
        logger_info.info('Attempting websocket connection with tydom hub.......................')
        logger_info.info('Host Target :{}'.format(self.host))
...
############ Utils
    ...
    async def put_alarm_cdata(self, device_id, alarm_id=None, value=None, zone_id=None):
        ...
        try:
            ...
            logger_info.info("put_alarm_cdata ERROR: {}".format(e))
            #print(a_bytes)
    ...
    async def setup(self):
        ...
        '''
        logger_info.info('Requesting 1st data...')
        await self.get_info()
        #print("##################################")
        #print("##################################")
